...
// retorna os eventos, se ele usar o campo de pesquisa usa o like, senão retorna todos com um offset de 10
...
if (isset($_GET['search']) && $_GET['search'] != '') {
  ...
  $sql = "SELECT * FROM eventos WHERE dataEvento >= NOW() ORDER BY dataEvento DESC LIMIT 10 OFFSET :offset";
  $stmt = $Coordenador->getPDO()->prepare($sql);
